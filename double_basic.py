# this file is the simulation experiment of a basic case
# with three firms (including two starter firms) and two orders
...
# order_process[][] - processes needed for each type of product. In this case: 2 processes and 1 order_types
order_process = [[1, 1]]
...
def build_model(due_time, fixed_cost):
    # Create model
    ...
    opt_model.add_constraint_(
        is_processed_by[0, 0] == 1
    )

    opt_model.add_constraint_(
        is_processed_by[1, 1] == 1
    )
...
if __name__ == '__main__':
    print("***************  Single Basic Case Experiment  ***************")
    due_time = [0, 0]
    fixed_cost = [0, 0, 0]
